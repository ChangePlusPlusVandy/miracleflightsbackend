...
describe('queryParameterExample', () => {
    it('should return 418 and a message with the query parameter', done => {
        chai_1.default
            ...
            (0, chai_1.expect)(res.text).to.equal('I cant make coffee! Thanks for your request though, Bob. Great use of a query parameter!');
            done();
        });
    });
    it('should return 400 if no query parameter is provided', done => {
        chai_1.default
            ...
            (0, chai_1.expect)(res.text).to.equal('Name is required');
            done();
        });
    });
});
